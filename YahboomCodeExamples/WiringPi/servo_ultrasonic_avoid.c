...
* @param[in]     speed1:Left motor speed; speed2:Right motor speed
* @param[out]    void
* @retval        void
* @par History   
*/
void spin_left(int speed1, int speed2)
{
  //Left motor back
  digitalWrite(Left_motor_go, LOW);     
  digitalWrite(Left_motor_back, HIGH);  
  softPwmWrite(Left_motor_pwm, speed1);

  //Right motor advance
  digitalWrite(Right_motor_go, HIGH);  
  digitalWrite(Right_motor_back, LOW); 
  softPwmWrite(Right_motor_pwm, speed2);
...
* @par History   
*/
void spin_right(int speed1, int speed2)
{
  //Left motor advance
  digitalWrite(Left_motor_go, HIGH);  
  digitalWrite(Left_motor_back, LOW);  
